...
public class ClientGUI extends JFrame {
	...
	private static final long serialVersionUID = 6123650131763200528L;
	...
	contentPane.setMaximumSize(new Dimension(30000, 32767));
	...
	if (btnNewButton == null) {
		...
		public void actionPerformed(ActionEvent arg0) {
			...
			if (socket == null) throw new Exception("Empty Socket");
			panel.removeAll();
			ChatPanel chatPanel = new ChatPanel(socket, name, "Server");
			panel.add(chatPanel);
			panel.updateUI();
			Thread t = new Thread(chatPanel);
			chatPanel.connect(name);
			...
			JOptionPane.showMessageDialog(contentPane, "Success", "Connected",
			                JOptionPane.INFORMATION_MESSAGE);
		    } catch (Exception e) {
			JOptionPane.showMessageDialog(contentPane,
			                "Error while connect, please check details and try again!\nDetails: " + e,
